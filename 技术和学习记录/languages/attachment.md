...
??
a strong feeling of affection for sb/sth 依恋；爱慕
belief in and support for an idea or a set of values 信念；信仰；忠诚；拥护
...
a short time spent working with an organization such as a hospital, school or part of the armed forces 暂时隶属于（某医院、学校、部队等）；短期在…工作
a document that you send to sb using email （用电子邮件发送的）附件
<!--SR:!2023-07-22,83,150!2023-10-13,271,270-->